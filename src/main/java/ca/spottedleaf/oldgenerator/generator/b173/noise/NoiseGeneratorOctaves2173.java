...
public class NoiseGeneratorOctaves2173 {

    private NoiseGenerator2173[] a;
    private int b;

    public NoiseGeneratorOctaves2173(Random random, int i) {
        this.b = i;
        this.a = new NoiseGenerator2173[i];

        for (int j = 0; j < i; ++j) {
            this.a[j] = new NoiseGenerator2173(random);
        }
    }
